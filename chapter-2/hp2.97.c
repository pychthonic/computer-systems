 ...
 */   
    ...
    unsigned E = 23 - left_shift_count + right_shift_count;
...
int main() {
    ...
    for (i = 0; i <= 10; ++i) {
        ...
        if ((floated_int != floated_int_computer)) {
            ...
            printf("\ni bits:\n");
            show_bits((byte_pointer) &i, sizeof(i));

            printf("\nfloated_int bits:\n");
            show_bits((byte_pointer) &floated_int, sizeof(floated_int));

            printf("\nfloated_int_computer bits:\n");
            show_bits((byte_pointer) &floated_int_computer, sizeof(floated_int_computer));
